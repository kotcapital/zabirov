...
$category_name = ArrayHelper::getValue($category, Yii::$app->request->get('category_id')); 
$manufacture_name = ArrayHelper::getValue($manufacture, Yii::$app->request->get('manufacture_id')); 
